# Security — leka-product-catalogs
...
### 3. GitHub
- [ ] Branch protection on `main`: applied via `apply-branch-protection.sh eukrit/leka-product-catalogs`
...
- [ ] Remove GitHub collaborator: `gh api -X DELETE repos/eukrit/leka-product-catalogs/collaborators/[username]`
