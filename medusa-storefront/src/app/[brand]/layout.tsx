...
export default function BrandLayout({
  ...
  const vendorTheme = getVendorTheme(brandSlug)

  return (
    <div className="min-h-screen" style={{ backgroundColor: vendorTheme?.colors.bg ?? "#F9FAFB" }}>
      {vendorTheme ? (
        <VendorHeader brand={brand} theme={vendorTheme} onOpenCart={openCart} />
      ) : (
