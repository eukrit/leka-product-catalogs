# Collaborators — leka-product-catalogs
...
- **Eukrit Seang** <eukrit@goco.bz>
  ...
  - GitHub: Owner of `eukrit/leka-product-catalogs`
...
- **Scope:**
  ...
  - **GitHub:** Write on `eukrit/leka-product-catalogs` (branch protection on `main` gates all merges)
